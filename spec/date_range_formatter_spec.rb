...
RSpec.describe(DateRangeFormatter) do
  ...
  it "formats a date range for the same month with ending time only" do
  ...
  it "formats a date range for the same year with ending time only" do
  ...
  it "formats a date range for different year with ending time only" do
